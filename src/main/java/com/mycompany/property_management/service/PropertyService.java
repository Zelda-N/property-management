...
public interface PropertyService {
    ...
    PropertyDTO updateOwnerName(@RequestBody PropertyDTO propertyDTO, Long propertyId);
    PropertyDTO updateOwnerEmail(@RequestBody PropertyDTO propertyDTO, Long propertyId);
